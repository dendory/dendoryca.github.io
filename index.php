    ...
    <section id="author-section" class="author-section section theme-bg-primary py-5">
	    <div class="container py-3">
		    ...
		    <div class="author-bio single-col-max mx-auto">
				...
				<p><center><a class="theme-link" target="_blank" href="https://blog.dendory.ca">Blog</a> | <a class="theme-link" target="_blank" href="https://www.linkedin.com/in/patrick-lambert-530383162/">LinkedIn</a> | <a class="theme-link" target="_blank" href="https://twitter.com/Dendory_net">Twitter</a></center></p>
		    </div><!--//author-bio-->
