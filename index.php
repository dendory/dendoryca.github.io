    ...
    <section id="contactus" class="form-section">
	    <div class="container">
		    <div class="lead-form-wrapper single-col-max mx-auto theme-bg-light rounded p-5">
			    ...
			    <div class="form-intro text-center mb-3">You can contact us by email at <a href='mailto:contact@dendory.ca'>contact@dendory.ca</a>, by phone at (514) 243-8176, or enter your contact details here and we will get back to you within 24h.</div>
    ...
    <section id="author-section" class="author-section section theme-bg-primary py-5">
	    <div class="container py-3">
		    ...
		    <div class="author-bio single-col-max mx-auto">
				...
				<br><p><center><a class="theme-link" target="_blank" href="https://blog.dendory.ca"><i class="fab fa-blogger fa-3x"></i></a> &nbsp; <a class="theme-link" target="_blank" href="https://www.linkedin.com/in/patrick-lambert-530383162/"><i class="fab fa-linkedin fa-3x"></i></a> &nbsp; <a class="theme-link" target="_blank" href="https://twitter.com/Dendory_net"><i class="fab fa-twitter fa-3x"></i></a> &nbsp; <a class="theme-link" target="_blank" href="https://www.youtube.com/channel/UCr_Pylv-5h2g1vI8GyibRIQ"><i class="fab fa-youtube fa-3x"></i></a></center></p>
		    </div><!--//author-bio-->
